...
class TestCarosu extends React.Component {
  state = {
    galleryItems: [1, 2, 3, 4, 5, 6].map((i) =>  <div key={i}><img src="assets/images/home_anna.png" role="presentation" width="90%"></img><div className="d-flex test-card"><div><img  src="assets/images/Jared.png" role="presentation" width="100%"/></div><div><p className="general">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p><p className='title'>Jared Ellis</p><p className='middle'>Student</p></div></div></div>),
